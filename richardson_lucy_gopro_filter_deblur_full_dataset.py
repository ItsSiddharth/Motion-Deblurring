...
already_deblurred = os.listdir("/home/nam/projects/sid/Motion-Deblurring/gopro_deblur/deblur_richardson_filter")
for image_file in tqdm(list_of_files):
    if image_file not in already_deblurred:
        ...
        full_path_sharp = os.path.join("/home/nam/projects/sid/Motion-Deblurring/gopro_deblur/sharp/images", image_file)
        ...
        deblurred_img_pil.save(f"gopro_deblur/deblur_richardson_filter/{image_file}")
